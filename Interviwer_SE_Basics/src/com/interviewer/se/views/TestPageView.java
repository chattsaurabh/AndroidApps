package com.interviewer.se.views;
...
import com.interviewer.se.abs.AbsPannerView;
...
//				m_cont.startActivity(new Intent(RESULT_ACTIVITY));
		...
		LayoutParams lp = new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT/*(int) m_cont.getResources().getDimension(R.dimen.test_page_radio_btn_ht)*/);
